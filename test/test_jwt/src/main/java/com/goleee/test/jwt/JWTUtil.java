...
public class JWTUtil {
    public static final long DAY_TTL = 1111111111;
    private static final String APP_ID = "aaaa";
    private static final String APP_SECRET = "aadsfasfasdfafsdfsfadsafsdfasfsfadfsfasdfsbbbb";
